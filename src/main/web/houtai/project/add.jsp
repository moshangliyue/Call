        ...
        <div class="box">
            <div class="box_border">
                ...
                <div class="box_center">
                    <form action="${pageContext.request.contextPath}/pro/saveInfo" class="jqtransform"
                        ...
                        <table class="form_table pt15 pb15" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <input type="text" name="pname" class="input-text lh30" size="40">
                                </td>
                            </tr>
                            <tr>
                      ...
                      <div class="select_border"> 
                        ...
                        <option value="赛事">赛事</option>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <input type="text" name="pamount" class="input-text lh30" size="40">元
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <input type="text" name="pcomname" class="input-text lh30" size="40">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <input type="text" name="pcomphon" class="input-text lh30" size="40">
                                </td>
                            </tr>
                        ...
                        <div class="select_containers "> 
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <input type="text" name="pbanknumber" class="input-text lh30" size="40">
                                </td>
                            </tr>
                      ...
                      <div class="select_border">
                        ...
                        <option value="体育赛事门票">体育赛事门票</option>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <input type="text" name="phamount" class="input-text lh30" size="40">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <input type="text" name="phnumberpeople" class="input-text lh30" size="40">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="td_right">回报时间：</td>
                                    <td class="">
                                        项目结束后&nbsp;&nbsp;<input type="text" name="phday" class="input-text lh30"
                                                                size="10">天
                                    </td>
                                </tr>
