    ...
    <div id="search_bar" class="mt10">
       <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">满标项目</b></div>
        ...
        <div class="box span10 oh">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                ...
                <tr class="tr">
                   ...
                   <td align="center">
                        <a href="listSupport.jsp" class="ext_btn">查看支持</a>&nbsp;&nbsp;
                        <a class="ext_btn" style="cursor:auto;">满标审核</a>
                   </td>	
                 </tr>
                 <tr class="tr">
                   <td align="center">2</td>
                   <td align="center">张学友演唱会</td>
                   <td align="center">项目未审核</td>
                   <td align="center">山东日报</td>
                   <td align="center">演出</td>
                   <td align="center">100</td>
                   <td align="center">100</td>
                   ...
                   <td align="center">
                        <a href="listSupport.jsp" class="ext_btn">查看支持</a>&nbsp;&nbsp;
                        <a href="javascript:if(confirm('确认满标?')) alert('操作成功！');" class="ext_btn">满标审核</a>
                   </td>	
                 </tr>
