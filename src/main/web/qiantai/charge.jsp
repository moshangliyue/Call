 	...
 	<div class="main">
		...
		<div class="col span_2_of_3">
				  <div class="contact-form">
					    <form method="post" action="javascript:alert('保存成功！');">
					    	<div>
						    	<span><label>用户名</label></span>
						    	<span><input name="userName" type="text" class="textbox" value="zhangsan" readonly /></span>
						    </div>
						    <div>
						    	<span><label>账户余额（元）</label></span>
						    	<span><input name="" type="text" class="textbox" value="1000" /></span>
						    </div>
						    <div>
						     	<span><label>充值金额（元）</label></span>
						    	<span><input name="" type="text" class="textbox"></span>
						    </div>
						   <div>
						   		<span><input type="submit" value="充值"  class="myButton"></span>
						  </div>
					    </form>
				  </div>
  				</div>
