				  ...
				  <div class="contact-form">
					    <form method="post" action="contact-post.html">
					    	<div>
						    	...
						    	<span><input name="userName" type="password" class="textbox" ></span>
						    </div>
						    <div>
						   ...
						   <div>
						   		<span><input type="submit" value="修  改"  class="myButton"><input type="button" value="返  回"  class="myButton1" onClick="history.back();"></span>
						  </div>
					    </form>
				  </div>
  				</div>
